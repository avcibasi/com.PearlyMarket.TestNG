...
//        Click on Become a Vendor
        ...
        MediaUtils.takeScreenshotOfTheEntirePageAsString();
//        Enter the email
        pearlyMarketLoginRegisterPage.registerEmail.sendKeys("testngteam06@outlook.com");
...
//        Check your e-mail
        ...
        Driver.getDriver().findElement(By.xpath("//input[@type='email']")).sendKeys("testngteam06@outlook.com");
