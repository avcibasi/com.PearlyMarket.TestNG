...
//        Click on Become a Vendor
        ...
        MediaUtils.takeScreenshotOfTheEntirePageAsString();
//        Enter the email
        pearlyMarketLoginRegisterPage.registerEmail.sendKeys("testngteam06new@outlook.com");
...
//        Check your e-mail
        ...
        Driver.getDriver().findElement(By.xpath("//input[@type='email']")).sendKeys("testngteam06new@outlook.com");
        Driver.getDriver().findElement(By.xpath("//input[@type='submit']")).click();
        Driver.getDriver().findElement(By.id("i0118")).sendKeys(excelUtils.getCellData(2,0));
